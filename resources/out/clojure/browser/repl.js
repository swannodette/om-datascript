...
return (function (){
if(cljs.core.truth_((function (){var and__4863__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__13750 = script;
goog.object.set(G__13750,"type","text/javascript");

goog.object.set(G__13750,"onload",onload);

goog.object.set(G__13750,"onreadystatechange",onload);

return G__13750;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__13751 = script__$1;
goog.object.set(G__13751,"src",src);

return G__13751;
})():(function (){var G__13752 = script__$1;
goog.dom.setTextContext(G__13752,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4875__auto__ = reload;
...
var path_13753 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_13753);

goog.object.remove(goog.dependencies_.written,path_13753);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_13753)].join(''));
} else {
}
