...
var script__$1 = (function (){var G__17234 = script;
goog.object.set(G__17234,"type","text/javascript");

goog.object.set(G__17234,"onload",onload);

goog.object.set(G__17234,"onreadystatechange",onload);

return G__17234;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__17235 = script__$1;
goog.object.set(G__17235,"src",src);

return G__17235;
})():(function (){var G__17236 = script__$1;
goog.dom.setTextContext(G__17236,opt_sourceText);
...
var path_17237 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_17237);

goog.object.remove(goog.dependencies_.written,path_17237);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_17237)].join(''));
} else {
}
